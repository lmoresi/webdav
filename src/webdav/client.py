...
class Client(object):
    ...
    def __init__(self, options):
        ...
        :param options: the dictionary of connection options to WebDAV can include proxy server options.
            ...
            `webdav_auth`: (optional) Requests-compatible auth object for WebDAV server can be empty in case using of token auth.
            `webdav_token': (optional) token for WebDAV server can be empty in case using of requests-compatible auth object.
            ...
            Proxy settings (optional):
             ...
             `proxy_auth`: requests-compatible auth object for proxy server.
        """
